...
ALTER TABLE "interviews" ADD COLUMN "difficulty_level" text;--> statement-breakpoint
ALTER TABLE "interviews" ADD COLUMN "question_generation_status" text DEFAULT 'pending';--> statement-breakpoint
